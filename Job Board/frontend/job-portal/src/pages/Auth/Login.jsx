...
<div className="relative">
  ...
  <button
   ...
   className="absolute right-3 top-1/2 transfrom -translate-y-1/2 text-gray-400 hover:text-gray-600"
   >
...
<div className="text-center">
  <p className="text-gray-600">
    ...
    <a href="/signup" className="text-blue-600 hover:text-blue-700 font font-medium">
    Create one here
    </a>
    </p>
    </div>
