      ...
      <div className='container mx-auto px-4'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            >
             Connect talended professionals with innovative companies.
             Your next career move or perfect candidates is just onne click away.
             </motion.p> 
                    ...
                    >
                      {stats.map((stat, index)=>(
                        ...
                        >
                          ...
                          <div className='text-sm text-gray-600 font-medium'>{stat.lable}</div>
                          </motion.div>
                      ))}
                      </motion.div>
                      </div>
