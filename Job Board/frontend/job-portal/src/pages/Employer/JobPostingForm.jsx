            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white shadow-xl rounded-2xl p-6">
                        ...
                        {/* Header row with title on left and preview button on right */}
                        ...
                        <div className=''>
                            <button
                                ...
                                className="group flex items-center space-x-2 px-4 py-2 text-sm font-medium text-gray-600 hover:text-white bg-white/50 hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-600 border rounded-lg"
                            >
                    ...
                    helperText="Include key responsibilities, day-to-day tasks"
                    required
                    />
                    ...
                    helperText="Include required skills, experience level, education"
                    required
                    />
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <input
                            ...
                            className='w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20
focus:border-blue-500 tarnsition-colors durations-200'
                        />
                        </div>
                        <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
...
focus:border-blue-500 tarnsition-colors durations-200'
                    ...
                    {errors.salary && (
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700
focus:outline-none focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-400
