              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-0">
                  ...
                  {user?.companyLogo ? (
                    ...
                    <div className="h-20 w-20 bg-gray-200 border-2 border-gray-200 rounded-2xl flex items-center justify-center">
                ...
                <div className="flex flex-wrap gap-3 mt-6 md:mt-0">
                  ...
                  <span className="px-4 py-2 text-sm bg-purple-700 text-white font-semibold rounded-full border border-purple-200">
                    {JOB_TYPES.find((j) => j.value === formData.jobType)?.label}
                  </span>
                  <div className="flex items-center space-x-1 px-3 py-1 bg-gray-50 text-sm text-gray-700 rounded-full border border-gray-200">
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-sm md:text-lg font-bold text-gray-900 mt-2">
                    {
                ...
                <div className="hidden md:flex items-center space-x-2 text-sm text-emerald-700 bg-emerald-100 px-3 py-1 rounded-full mt-4">
              ...
              <div className="space-y-4">
                <div className="text-2xl font-bold text-gray-900 flex items-center">
                  <div className="w-1 h-8 bg-gradient-to-b from-blue-500 to-blue-100 mr-2" />
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-gray-900 flex items-center space-x-2">
                  <div className="w-1 h-8 bg-gradient-to-b from-purple-500 to-pink-500" />
                  <span className="text-base md:text-lg">
                    What We’re Looking For
                  </span>
                </h3>
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 border p-4 rounded-md">
                  <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">
